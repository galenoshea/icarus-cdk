...
### Overview
Version 0.5.1 is a patch release that fixes critical issues with the v0.3.0 release.
...
### Overview
Version 0.5.1 is primarily a maintenance release with improved documentation and synchronized versioning across all workspace crates.

### Changes

#### Version Synchronization
All crates in the workspace now use the same version number (0.5.1):
- `icarus`
- `icarus-core`
- `icarus-derive`
- `icarus-canister`
...
**Action Required**: Update your `Cargo.toml` dependencies to use version 0.5.1:
```toml
[dependencies]
icarus = "0.3.0"
...
- **Current Version (0.5.1)**: Full support
