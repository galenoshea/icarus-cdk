...
/// Marker trait for types that can be stored in stable storage
///
/// This is a convenience trait that extends Storable with additional
/// constraints needed for Icarus stable storage patterns.
#[cfg(feature = "canister")]
pub trait IcarusStorable: Storable + Clone + std::fmt::Debug {}
